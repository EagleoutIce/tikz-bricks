...
\BrickOneXFour{0,\h,0}{green}
\BrickOneXFour{1,\h,0}{red}
\BrickOneXFour{2,\h,0}{green}
\BrickOneXFour{3,\h,0}{red}
...
\BrickFourXOne{0,2*\h,0}{orange}

\foreach \xyi in {0,4,8,12} {
    \BrickOneXFour{4,0,\xyi}{teal}
}
\BrickOneXFour{0,\h,12}{green}

\BrickTwoXFour{11,\h,12}{green}
\BrickOneXFour{11,2*\h,12}{red}
\BrickOneXFour{12,2*\h,12}{teal}

\BrickTwoXTwo{12,2*\h,5}{blue!50!white}
\BrickFourXOne{-5,2*\h,12}{red}
\end{tikzpicture}}
\end{document}